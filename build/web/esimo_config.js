var OVROOT = "http://" + document.URL.split("/")[2] + "/OceanViewerPortlet/";
var OV_PREFERENCES_URL = "/portal/auth/portal/admin/gis/OceanViewer/geoservices-oceanviewerWindow" + "?action=1";
...
window.CONFIG = {
    ...
    CACHE_URL : list.get("basemapUrl"),//"http://10.1.91.236:8080/cache/service/wms",
    REST_URL : list.get("restUrl"),//"http://portal.esimo.ru/restserver/services/requests",
    GEOSERVER : list.get("geoserverRemoteURL")//"http://10.1.91.236:8080/resources/"
}
